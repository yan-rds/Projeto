public class Tratamentos {
    ...
    public void tratarAnsiedade() {
        ...
        concatenador.append("\nAfinal, eles podem ajudar qualquer pessoa a modificar determinados comportamentos que podem aumentar seu bem-estar e melhorar suas relações interpessoais de forma bastante positiva.");
        comoTratar = concatenador.toString();
    }

    public void tratarTimidez() {
        StringBuilder concatenador = new StringBuilder();
        concatenador.append("\nTem algumas coisas que você pode fazer para lidar com a timidez\n");
        concatenador.append("\n\n\tAutoconhecimento\n");
        concatenador.append("\nO primeiro passo é se conhecer e verificar até que ponto a timidez está impedindo de conquistar seus objetivos");
        concatenador.append("\n\n\tPrograme seu cérebro\n");
        concatenador.append("\nDiariamente diga a você mesmo que és capaz de enfrentar qualquer tipo de situação e siga firme.");
        concatenador.append("\n\n\tFaça exercícios para praticar a fala em público\n");
        ...
        concatenador.append("\n\n\tAcredite em você e veja a diferença em sua vida\n");
        concatenador.append("\nAcredite em você e siga enfrente, você tem plenas condições de seguir em frente e vencer todo e qualquer obstáculo em sua vida.");
